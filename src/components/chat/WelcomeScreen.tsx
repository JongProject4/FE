      ...
      <div className="w-full flex flex-col gap-2.5">
        ...
        {SAMPLE_QUESTIONS.map(({ icon, text }) => (
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3.5 bg-white border border-[rgba(82,183,136,0.15)] rounded-[14px] text-left active:scale-[0.98] transition-transform hover:border-[#52B788] hover:bg-[rgba(82,183,136,0.08)]"
          >
